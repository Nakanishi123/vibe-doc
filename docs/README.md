...
visible and shows a small error instead of breaking the page. A literal `\n` in Mermaid source is
rendered as a line break, which also supports diagrams generated by AI tools that emit escaped
newlines in labels.
